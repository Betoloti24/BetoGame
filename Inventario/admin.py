...
class ProductoAdmin(admin.ModelAdmin):
    list_display = ('id', 'set_nombre', 'set_tipo_producto', 'set_precio_venta', 'set_precio_compra', 'set_cant_invent', 'set_fecha_creacion', 'set_fecha_actualizacion')
...
class HistoricoPreciosAdmin(admin.ModelAdmin):
    list_display = ('id', 'set_id_producto', 'set_precio', 'set_fecha_creacion', 'set_vigente')
    list_filter = ('vigente',)
...
class EntradaAdmin(admin.ModelAdmin):
    list_display = ('id', 'set_id_producto', 'set_tipo_entrada', 'set_costo_punidad', 'set_costo_mercancia', 'set_costo_envio', 'set_cant_ingresada', 'set_fecha_creacion')
