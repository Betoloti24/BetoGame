...
class CuentaAdmin(admin.ModelAdmin):
    list_display = ['id', 'set_id_cliente', 'set_monto_deberdolar', 'set_monto_pagado', 'set_fecha_hora_creacion', 'set_fecha_hora_ultimo_pago', 'set_fecha_hora_pago']
    search_fields = ['id', 'id_cliente__nombre', 'id_cliente__apellido']
    date_hierarchy = 'fh_creacion'
    ordering = ('-fh_creacion',)
    readonly_fields = ('fh_creacion', 'fh_pago', 'monto_deberdolar', 'monto_pagado', 'fh_ultimo_pago', "id_cliente")
    ...
    def set_monto_deberdolar(self, obj):
        return f"{obj.monto_deberdolar:.2f}$"
    ...
    set_monto_pagado.short_description = 'Pagado ($)'
    set_monto_deberdolar.short_description = 'Deuda ($)'
...
class PagoAdmin(admin.ModelAdmin):
    list_display = ['id', 'set_id_cuenta', 'set_montodolar', 'set_met_pago', 'set_fecha_hora_pago']
    ...
    def set_fecha_hora_pago(self, obj):
        hora = obj.fh_pago - timedelta(hours=4)
        return hora.strftime('%d/%m/%Y %I:%M:%S %p')
    def set_montodolar(self, obj):
        return f"{obj.montodolar:.2f}$"
    ...
    set_montodolar.short_description = 'Pagado ($)'
...
class CierreAdmin(admin.ModelAdmin):
    list_display = ['set_fecha_hora_cierre', 'set_totalbs_ingreso', 'set_totaldolar_ingreso', 'set_totalbs_fianza', 'set_totaldolar_fianza', 'set_total_horas', 'set_total_jugadores', 'set_totalbs_costoent', 'set_totaldolar_costoent']
