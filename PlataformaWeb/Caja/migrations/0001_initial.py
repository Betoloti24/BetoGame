    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monto_deberbs', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
                ...
                ('compras', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Local.compra')),
                ('id_cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Local.cliente')),
                ('sesiones', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Local.sesion')),
            ],
            options={
                'verbose_name': 'Cuenta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('met_pago', models.CharField(choices=[('efectivodolar', 'EfectivoDolar'), ('efectivobs', 'EfectivoBs'), ('tarjeta', 'Tarjeta'), ('pago_movil', 'Pago Móvil')], max_length=13)),
                ('montodolar', models.DecimalField(decimal_places=2, max_digits=5)),
                ('montobs', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
